...
namespace MissionPlanner
{
    public class CurrentState : ICloneable
    {
        ...
        //动力输出百分比
        [DisplayText("Throttle Percent")]
        public uint throttle_percent { get; set; }
        //下一航点
	...
	float _crit_aoa = 25;
        ...
        [DisplayText("Time since ARM in Air (sec)")]
            ...
            lock (this)
            {
                if (DateTime.Now > lastupdate.AddMilliseconds(50) || updatenow) // 20 hz
                {
                    ...
                    if (mavLinkMessage != null)
                    {
                        ...
                        //获取动力输出
                        if (vfr.throttle > 100) throttle_percent = 0;
                        else throttle_percent = vfr.throttle;
