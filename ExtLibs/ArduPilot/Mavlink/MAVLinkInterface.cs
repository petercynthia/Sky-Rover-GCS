...
{
    public delegate void ProgressReport(int progress,string status);
    public class MAVLinkInterface : MAVLink, IDisposable, IMAVLinkInterface, IMAVLinkInterfaceLogRead
    {
        ...
        public event ProgressReport ProgressReportEvent;
        ...
        public void OpenComport(bool getparams, bool skipconnectedcheck = false, bool dlgVisible = false)
        {
            ...
            frmProgressReporter.WorkStatus += FrmProgressReporter_WorkStatus;
        ...
        private void FrmProgressReporter_WorkStatus(int progress, string status)
        {
            if (ProgressReportEvent != null) ProgressReportEvent(progress,status);
        }
                ...
                while (true)
                {
                    ...
                    if (DateTime.Now > deadline)
                    {
                        ...
                        else
                        {
                           ...
                           // if (frmProgressReporter != null) frmProgressReporter.Dispose();
...
4. Try a diffrent usb port\n\n" +
                ...
                byte[] temp = ASCIIEncoding.ASCII.GetBytes("Sky Rover " + getAppVersion() + "\0");
