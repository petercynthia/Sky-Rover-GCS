                ...
                if (bgon == true)
                {
                    ...
                    if (bg.Height != 0)
                    {
                        using (LinearGradientBrush linearBrush = new LinearGradientBrush(
                            bg, Color.FromArgb(0x00,0x64,0xCA), Color.LightBlue, LinearGradientMode.Vertical))
                        {
                    ...
                    //Color.FromArgb(0x64, 0x31, 0x02)
                    if (bg.Height != 0)
                    {
                        using (
                            LinearGradientBrush linearBrush = new LinearGradientBrush(
                                bg, Color.FromArgb(0x64, 0x31, 0x02), Color.FromArgb(0x64, 0x31, 0x02),
