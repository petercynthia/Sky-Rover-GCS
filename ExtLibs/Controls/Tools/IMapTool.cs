...
{
    //public delegate void OnFinished(GMapPolygon gMapPolygon);
    ...
    /// </summary>
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    void DoMouseEnter(GMapMarker obj);

    /// <summary>
    /// Function to perform some action when the mouse leaves the map
    /// </summary>
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    void  DoMouseLeave(GMapMarker obj);
    ...
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    bool DoMouseDoubleClick(object sender, MouseEventArgs mouseEventArgs);
        ...
        /// <param name="mouseEventArgs">The mouse event arguments</param>
        /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
        bool DoMouseClick(object sender,MouseEventArgs mouseEventArgs);
    /// <summary>
    ...
    /// <param name="mouseEventArgs">The mouse event arguments</param>
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    bool DoMouseDown(object sender, MouseEventArgs mouseEventArgs);
    ...
    /// <param name="mouseEventArgs">The mouse event arguments</param>
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    bool DoMouseMove(object sender, MouseEventArgs mouseEventArgs);
    ...
    /// <param name="mouseEventArgs">The mouse event arguments</param>
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    bool DoMouseUp(object sender, MouseEventArgs mouseEventArgs);
    ...
    /// <param name="mouseEventArgs">The mouse event arguments</param>
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    bool DoMouseWheel(object sender, MouseEventArgs mouseEventArgs);
    ...
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    bool DoKeyDown(object sender, KeyEventArgs keyEventArgs);
    ...
    /// <param name="keyEventArgs">The key event arguments</param>
    /// <returns><value>true</value> if the action was handled and <b>no</b> other action should be taken</returns>
    bool DoKeyUp(object sender, KeyEventArgs keyEventArgs);
