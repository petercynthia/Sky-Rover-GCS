...
namespace GMap.NET.MapProviders
{
    ...
    public class GMapProviders
    {
      ...
      public static readonly OpenStreetMapSurferTerrainProvider OpenStreetMapSurferTerrain = OpenStreetMapSurferTerrainProvider.Instance;
        ...
        //public static readonly TiandituCiaMapProvider tiandituCiaMapProvider = TiandituCiaMapProvider.Instance;
        //public static readonly TiandituCvaMapProvider tiandituCvaMapProvider = TiandituCvaMapProvider.Instance;
        public static readonly TiandituImageProvider tiandituImageProvider = TiandituImageProvider.Instance;
        public static readonly TiandituMapProvider tiandituMapProvider = TiandituMapProvider.Instance;
