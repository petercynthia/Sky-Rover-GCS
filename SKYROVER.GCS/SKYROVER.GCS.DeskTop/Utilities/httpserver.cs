        ...
        public void ProcessClient(object clientobj)
        {
            ...
            using (client)
            {
                try
                {
                    ...
                    MainUI.MainUIInstance.getHUD.streamjpgenable = true;
                    ...
                    if (url.Contains(" /websocket/server"))
                    {
                        using (var writer = new StreamWriter(stream, Encoding.Default))
                        {
                            ...
                            while (client.Connected)
                            {
                                ...
                                var cs = JsonConvert.SerializeObject(MainUI.comPort.MAV.cs);
                                var wps = JsonConvert.SerializeObject(MainUI.comPort.MAV.wps);
                    ...
                    else if (url.Contains(" /websocket/raw"))
                    {
                        using (var writer = new StreamWriter(stream, Encoding.Default))
                        {
                            ...
                            MainUI.comPort.OnPacketReceived += action;
                    ...
                    else if (url.Contains(" /location.kml"))
                    {
                        ...
                        pmplane.Name = "P/Q " + MainUI.comPort.MAV.cs.altasl;

                        pmplane.Visibility = true;

                        SharpKml.Dom.Location loc = new SharpKml.Dom.Location();
                        loc.Latitude = MainUI.comPort.MAV.cs.lat;
                        loc.Longitude = MainUI.comPort.MAV.cs.lng;
                        loc.Altitude = MainUI.comPort.MAV.cs.altasl;

                        if (loc.Altitude < 0)
                            loc.Altitude = 0.01;

                        SharpKml.Dom.Orientation ori = new SharpKml.Dom.Orientation();
                        ori.Heading = MainUI.comPort.MAV.cs.yaw;
                        ori.Roll = -MainUI.comPort.MAV.cs.roll;
                        ori.Tilt = -MainUI.comPort.MAV.cs.pitch;
                        ...
                        SharpKml.Dom.LookAt la = new SharpKml.Dom.LookAt()
                        {
                            ...
                            Tilt = 80,
                            Heading = MainUI.comPort.MAV.cs.yaw,
    ...
    <Folder>
            ...
            <Link>
                <href> http://127.0.0.1:56781/wps.kml</href>
                    ...
                    else if (url.Contains(" /wps.kml"))
                    {
                        ...
                        try
                        {
                            foreach (var point in MainUI.MainUIInstance.pointlist)
                            {
                             ...
                             url.ToLower().Contains(" /both.jpg"))
                    {
                        ...
                        while (client.Connected)
                        {
                            ...
                            {
                               MainUI.MainUIInstance.getHUD.streamjpgenable = true;
                                data = MainUI.MainUIInstance.getHUD.streamjpg.ToArray();
                            }
                            else if (url.ToLower().Contains("map"))
                            {
                                data = GetControlJpegRaw(MainUI.MainUIInstance.getGMAP);
                            }
                            else
                            {
                                MainUI.MainUIInstance.getHUD.streamjpgenable = true;
                                Image img1 = Image.FromStream(MainUI.MainUIInstance.getHUD.streamjpg);
                                Image img2 = GetControlJpeg(MainUI.MainUIInstance.getGMAP);
                        ...
                        MainUI.MainUIInstance.getHUD.streamjpgenable = false;
                        stream.Close();
                    }
                    /////////////////////////////////////////////////////////////////
                    else if (url.Contains(" /guided?"))
                    {
                        ...
                        if (match.Success)
                        {
                            ...
                            try
                            {
                                MainUI.comPort.setGuidedModeWP(gwp);
                            }
                            catch
                            {
                            }
        ...
        "NAV_CONTROLLER_OUTPUT": {"msg": {"wp_dist": 0, "nav_pitch": 0.0, "target_bearing": 0, "nav_roll": 0.0, "aspd_error": 0.0, "alt_error": 0.0, "mavpackettype": "NAV_CONTROLLER_OUTPUT", "xtrack_error": 0.0, "nav_bearing": 0}, "index": 687, "time_usec": 0}}
                      */
                        ...
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.ATTITUDE) != null)
                        {
                            var tmsg = MainUI.comPort.MAV.getPacket((uint)MAVLink.MAVLINK_MSG_ID.ATTITUDE)
                        ...
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.ATTITUDE) != null)
                            message.ATTITUDE = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.ATTITUDE)
                                        .ToStructure<MAVLink.mavlink_attitude_t>()
                            };
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.VFR_HUD) != null)
                            message.VFR_HUD = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.VFR_HUD)
                                        .ToStructure<MAVLink.mavlink_vfr_hud_t>()
                            };
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.NAV_CONTROLLER_OUTPUT) != null)
                            message.NAV_CONTROLLER_OUTPUT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.NAV_CONTROLLER_OUTPUT)
                                        .ToStructure<MAVLink.mavlink_nav_controller_output_t>()
                            };
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.GPS_RAW_INT) != null)
                            message.GPS_RAW_INT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.GPS_RAW_INT)
                                        .ToStructure<MAVLink.mavlink_gps_raw_int_t>()
                            };
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.HEARTBEAT) != null)
                            message.HEARTBEAT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.HEARTBEAT)
                                        .ToStructure<MAVLink.mavlink_heartbeat_t>()
                            };
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.GPS_STATUS) != null)
                            message.GPS_STATUS = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.GPS_STATUS)
                                        .ToStructure<MAVLink.mavlink_gps_status_t>()
                            };
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.STATUSTEXT) != null)
                            message.STATUSTEXT = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.STATUSTEXT)
                                        .ToStructure<MAVLink.mavlink_statustext_t>()
                            };
                        if (MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.SYS_STATUS) != null)
                            message.SYS_STATUS = new Message2()
                            {
                                index = 1,
                                msg =
                                    MainUI.comPort.MAV.getPacket((byte)MAVLink.MAVLINK_MSG_ID.SYS_STATUS)
                            ...
                            message.SYS_STATUS =
                                new Message2()
                                {
                                    ...
                                    msg =
                                        ...
                                        {
                                            master_in = (int)MainUI.comPort.MAV.packetsnotlost,
                                            mavpackettype = "META_LINKQUALITY",
                                            master_out = MainUI.comPort.packetcount,
                                            packet_loss = 100 - MainUI.comPort.MAV.cs.linkqualitygcs,
                                            mav_loss = 0
                                        }
                                };
...
";
        ...
        void refreshmap()
        {
            MethodInvoker m = delegate () { MainUI.MainUIInstance.getGMAP.Refresh(); };
            MainUI.MainUIInstance.Invoke(m);
        }
