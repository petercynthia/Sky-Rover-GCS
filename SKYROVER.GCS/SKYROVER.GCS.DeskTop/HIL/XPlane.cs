...
namespace SKYROVER.GCS.DeskTop.HIL
{
    public class XPlane : Hil, IDisposable
    {
        ...
        {
            roll_out = (float) MainUI.comPort.MAV.cs.hilch1/rollgain;
            pitch_out = (float) MainUI.comPort.MAV.cs.hilch2/pitchgain;
            throttle_out = ((float) MainUI.comPort.MAV.cs.hilch3)/throttlegain;
            rudder_out = (float) MainUI.comPort.MAV.cs.hilch4/ruddergain;
        ...
        public override void SendToAP(sitl_fdm sitldata)
        {
            ...
            MainUI.comPort.sendPacket(hilstate, MainUI.comPort.sysidcurrent, MainUI.comPort.compidcurrent);

            MainUI.comPort.sendPacket(new MAVLink.mavlink_vfr_hud_t()
            {
