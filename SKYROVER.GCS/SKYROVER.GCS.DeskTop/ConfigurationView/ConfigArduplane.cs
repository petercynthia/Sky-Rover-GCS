...
namespace SKYROVER.GCS.DeskTop.ConfigurationView
{
    public partial class ConfigArduplane : UserControl, IActivate
    {
        ...
        private void InitParams() {
            ...
            Q_FRAME_CLASS.setup(
               ParameterMetaDataRepository.GetParameterOptionsInt("Q_FRAME_CLASS", MainUI.comPort.MAV.cs.firmware.ToString())
                   .ToList(), "Q_FRAME_CLASS", MainUI.comPort.MAV.param);
            Q_FRAME_TYPE.setup(
             ParameterMetaDataRepository.GetParameterOptionsInt("Q_FRAME_TYPE", MainUI.comPort.MAV.cs.firmware.ToString())
                 .ToList(), "Q_FRAME_TYPE", MainUI.comPort.MAV.param);
            #endregion

            #region 自稳Roll、PITCH、YAW
            Q_A_ANG_RLL_P.setup(0, 0, 1, 0, "Q_A_ANG_RLL_P", MainUI.comPort.MAV.param);
            Q_A_ANG_PIT_P.setup(0, 0, 1, 0, "Q_A_ANG_PIT_P", MainUI.comPort.MAV.param);
            Q_A_ANG_YAW_P.setup(0, 0, 1, 0, "Q_A_ANG_YAW_P", MainUI.comPort.MAV.param);
            #endregion

            #region  Roll 速率
            Q_A_RAT_RLL_P.setup(0, 0, 1, 0, "Q_A_RAT_RLL_P", MainUI.comPort.MAV.param);
            Q_A_RAT_RLL_I.setup(0, 0, 100, 0, "Q_A_RAT_RLL_I", MainUI.comPort.MAV.param);
            Q_A_RAT_RLL_D.setup(0, 0, 100, 0, "Q_A_RAT_RLL_D", MainUI.comPort.MAV.param);
        ...
        private void SetQ_ParametersEnable(bool enable) {
          ...
          //  Q_ENABLE.Enabled = enable;
            ...
            #region 倾转垂起功能
            // Q_TILT_MASK.Enabled = enable;//(0, 0, 1, 0, "Q_TILT_MASK", MainUI.comPort.MAV.param);
        ...
        private void Q_TILT_MASK_1_CheckedChanged(object sender, EventArgs e)
        {
