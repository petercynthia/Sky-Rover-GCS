...
namespace SKYROVER.GCS.DeskTop
{
    ...
    /// 
    /// </summary>
    public class LocationwpEx
    {
        public LocationwpEx(int index)
        {
            this.index = index;
            WP = new Locationwp();
            locationwps = new List<Locationwp>();
        }
        /// <summary>
        /// 航点编号
        /// </summary>
        ...
        public Locationwp WP;
        /// <summary>
        /// 航点下对应的任务
        /// </summary>
        public List<Locationwp> locationwps;
    }
    class Common
    {
        ...
        public static Form LoadingBox(string title, string promptText)
        {
            ...
            System.ComponentModel.ComponentResourceManager resources =
                new System.ComponentModel.ComponentResourceManager(typeof(MainUI));
        ...
        public static DialogResult MessageShowAgain(string title, string promptText)
        {
           ...
           MissionPlanner.Controls.MyButton buttonOk = new MissionPlanner.Controls.MyButton();
            System.ComponentModel.ComponentResourceManager resources =
                new System.ComponentModel.ComponentResourceManager(typeof(MainUI));
            form.Icon = ((System.Drawing.Icon)(resources.GetObject("$this.Icon")));
        ...
        {
            return MissionPlanner.ArduPilot.Common.getModesList(MainUI.comPort.MAV.cs.firmware);
        }
    }
}
