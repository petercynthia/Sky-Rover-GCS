...
namespace SKYROVER.GCS.DeskTop.Calibration
{
  ...
  #error Unrecognised frame type
        ...
        private int get_motormax()
        {
            ...
            if (MainUI.comPort.MAV.aptype == MAVLink.MAV_TYPE.GROUND_ROVER)
            {
                return 4;
            }

            var enable = MainUI.comPort.MAV.param.ContainsKey("FRAME") || MainUI.comPort.MAV.param.ContainsKey("Q_FRAME_TYPE") || MainUI.comPort.MAV.param.ContainsKey("FRAME_TYPE");
            ...
            if (MainUI.comPort.MAV.param.ContainsKey("Q_FRAME_CLASS"))
            {
                var value = (int)MainUI.comPort.MAV.param["Q_FRAME_CLASS"].Value;
                switch (value)
                {
                    case 0:
                    case 1:
                ...
                frame_type = (int)MainUI.comPort.MAV.param["Q_FRAME_TYPE"].Value;
            }
            else if (MainUI.comPort.MAV.param.ContainsKey("FRAME"))
            {
                type = MainUI.comPort.MAV.aptype;
                frame_type = (int)MainUI.comPort.MAV.param["FRAME"].Value;
            }
            else if (MainUI.comPort.MAV.param.ContainsKey("FRAME_TYPE"))
            {
                type = MainUI.comPort.MAV.aptype;
                frame_type = (int)MainUI.comPort.MAV.param["FRAME_TYPE"].Value;
            }
        ...
        private void testMotor(int motor, int speed, int time,int motorcount = 0)
        {
            ...
            {
                if (
                    !MainUI.comPort.doMotorTest(motor, MAVLink.MOTOR_TEST_THROTTLE_TYPE.MOTOR_TEST_THROTTLE_PERCENT,
