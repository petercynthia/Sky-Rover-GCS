...
namespace SKYROVER.GCS.DeskTop.Calibration
{
    public partial class ConfigHWCompass : UserControl, IActivate
    {
        ...
        public void Activate()
        {
            ...
            if (MainUI.comPort.MAV.cs.version > Version.Parse("3.2.1") &&
                MainUI.comPort.MAV.cs.firmware == Firmwares.ArduCopter2)
            {
            ...
            if (MainUI.comPort.MAV.cs.version >= Version.Parse("3.7.1") &&
                MainUI.comPort.MAV.cs.firmware == Firmwares.ArduPlane 
            ...
            else if ((MainUI.comPort.MAV.cs.capabilities & (uint)MAVLink.MAV_PROTOCOL_CAPABILITY.COMPASS_CALIBRATION) == 0)
            {
            ...
            CHK_enablecompass.setup(1, 0, "MAG_ENABLE", MainUI.comPort.MAV.param);
            CHK_compass_learn.setup(1, 0, "COMPASS_LEARN", MainUI.comPort.MAV.param);
            if (MainUI.comPort.MAV.param["COMPASS_DEC"] != null)
            {
                var dec = MainUI.comPort.MAV.param["COMPASS_DEC"].Value*MathHelper.rad2deg;
            ...
            if (MainUI.comPort.MAV.param["COMPASS_AUTODEC"] != null)
            {
                CHK_autodec.Checked = MainUI.comPort.MAV.param["COMPASS_AUTODEC"].ToString() == "1" ? true : false;
            }


            // Compass 1 settings
            CHK_compass1_use.setup(1, 0, "COMPASS_USE", MainUI.comPort.MAV.param);
            CHK_compass1_external.setup(1, 0, "COMPASS_EXTERNAL", MainUI.comPort.MAV.param);
            CMB_compass1_orient.setup(ParameterMetaDataRepository.GetParameterOptionsInt("COMPASS_ORIENT",
                    MainUI.comPort.MAV.cs.firmware.ToString()), "COMPASS_ORIENT", MainUI.comPort.MAV.param);
            ...
            int offset1_x = (int) MainUI.comPort.MAV.param["COMPASS_OFS_X"];
            int offset1_y = (int) MainUI.comPort.MAV.param["COMPASS_OFS_Y"];
            int offset1_z = (int) MainUI.comPort.MAV.param["COMPASS_OFS_Z"];
            ...
            if (MainUI.comPort.MAV.param.ContainsKey("COMPASS_MOT_X"))
            {
                LBL_compass1_mot.Text = "MOT          X: " +
                                        ((int) MainUI.comPort.MAV.param["COMPASS_MOT_X"]).ToString() +
                                        ",   Y: " + ((int) MainUI.comPort.MAV.param["COMPASS_MOT_Y"]).ToString() +
                                        ",   Z: " + ((int) MainUI.comPort.MAV.param["COMPASS_MOT_Z"]).ToString();
            }

            //if (!MainUI.DisplayConfiguration.displayCompassConfiguration)
            //{
            ...
            // Compass 2 settings
            if (MainUI.comPort.MAV.param.ContainsKey("COMPASS_EXTERN2"))
            {
                CHK_compass2_use.setup(1, 0, "COMPASS_USE2", MainUI.comPort.MAV.param);
                CHK_compass2_external.setup(1, 0, "COMPASS_EXTERN2", MainUI.comPort.MAV.param);
                CMB_compass2_orient.setup(ParameterMetaDataRepository.GetParameterOptionsInt("COMPASS_ORIENT2",
                    MainUI.comPort.MAV.cs.firmware.ToString()), "COMPASS_ORIENT2", MainUI.comPort.MAV.param);

                CMB_primary_compass.setup(typeof (CompassNumber), "COMPASS_PRIMARY", MainUI.comPort.MAV.param);

                int offset2_x = (int) MainUI.comPort.MAV.param["COMPASS_OFS2_X"];
                int offset2_y = (int) MainUI.comPort.MAV.param["COMPASS_OFS2_Y"];
                int offset2_z = (int) MainUI.comPort.MAV.param["COMPASS_OFS2_Z"];
                ...
                if (MainUI.comPort.MAV.param.ContainsKey("COMPASS_MOT2_X"))
                {
                    LBL_compass2_mot.Text = "MOT          X: " +
                                            ((int) MainUI.comPort.MAV.param["COMPASS_MOT2_X"]).ToString() +
                                            ",   Y: " + ((int) MainUI.comPort.MAV.param["COMPASS_MOT2_Y"]).ToString() +
                                            ",   Z: " + ((int) MainUI.comPort.MAV.param["COMPASS_MOT2_Z"]).ToString();
                }
            ...
            if (MainUI.comPort.MAV.param.ContainsKey("COMPASS_EXTERN3"))
            {
                CHK_compass3_external.setup(1, 0, "COMPASS_EXTERN3", MainUI.comPort.MAV.param);
                CHK_compass3_use.setup(1, 0, "COMPASS_USE3", MainUI.comPort.MAV.param);
                CMB_compass3_orient.setup(ParameterMetaDataRepository.GetParameterOptionsInt("COMPASS_ORIENT3",
                    MainUI.comPort.MAV.cs.firmware.ToString()), "COMPASS_ORIENT3", MainUI.comPort.MAV.param);

                int offset3_x = (int) MainUI.comPort.MAV.param["COMPASS_OFS3_X"];
                int offset3_y = (int) MainUI.comPort.MAV.param["COMPASS_OFS3_Y"];
                int offset3_z = (int) MainUI.comPort.MAV.param["COMPASS_OFS3_Z"];
                ...
                if (MainUI.comPort.MAV.param.ContainsKey("COMPASS_MOT3_X"))
                {
                    LBL_compass3_mot.Text = "MOT          X: " +
                                            ((int) MainUI.comPort.MAV.param["COMPASS_MOT3_X"]).ToString() +
                                            ",   Y: " + ((int) MainUI.comPort.MAV.param["COMPASS_MOT3_Y"]).ToString() +
                                            ",   Z: " + ((int) MainUI.comPort.MAV.param["COMPASS_MOT3_Z"]).ToString();
                }
            ...
            mavlinkComboBoxfitness.setup(ParameterMetaDataRepository.GetParameterOptionsInt("COMPASS_CAL_FIT",
                    MainUI.comPort.MAV.cs.firmware.ToString()), "COMPASS_CAL_FIT", MainUI.comPort.MAV.param);
        ...
        private void TXT_declination_Validated(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    MainUI.comPort.setParam("COMPASS_DEC", dec*MathHelper.deg2rad);
                }
            }
            catch
            {
        ...
        private void CHK_enablecompass_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (MainUI.comPort.MAV.param["MAG_ENABLE"] == null)
                {
                    CustomMessageBox.Show(Strings.ErrorFeatureNotEnabled, Strings.ERROR);
                }
                else
                {
                    MainUI.comPort.setParam("MAG_ENABLE", ((CheckBox) sender).Checked ? 1 : 0);
                }
            }
            catch
            {
        ...
        private void CHK_autodec_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (MainUI.comPort.MAV.param["COMPASS_AUTODEC"] == null)
                {
                    CustomMessageBox.Show("Not Available on " + MainUI.comPort.MAV.cs.firmware);
                }
                else
                {
                    MainUI.comPort.setParam("COMPASS_AUTODEC", ((CheckBox) sender).Checked ? 1 : 0);
                }
            }
            catch
            {
        ...
        private bool ReceviedPacket(MAVLink.MAVLinkMessage packet)
        {
            if (System.Diagnostics.Debugger.IsAttached)
                MainUI.comPort.DebugPacket(packet, true);
        ...
        private void BUT_OBmagcalstart_Click(object sender, EventArgs e)
        {
            try
            {
                MainUI.comPort.doCommand(MAVLink.MAV_CMD.DO_START_MAG_CAL, 0, 1, 1, 0, 0, 0, 0);
            }
            catch (Exception ex)
            {
                this.LogError(ex);
            ...
            packetsub1 = MainUI.comPort.SubscribeToPacketType(MAVLink.MAVLINK_MSG_ID.MAG_CAL_PROGRESS, ReceviedPacket);
            packetsub2 = MainUI.comPort.SubscribeToPacketType(MAVLink.MAVLINK_MSG_ID.MAG_CAL_REPORT, ReceviedPacket);
        ...
        private void BUT_OBmagcalaccept_Click(object sender, EventArgs e)
        {
            try
            {
                MainUI.comPort.doCommand(MAVLink.MAV_CMD.DO_ACCEPT_MAG_CAL, 0, 0, 1, 0, 0, 0, 0);
            ...
            MainUI.comPort.UnSubscribeToPacketType(packetsub1);
            MainUI.comPort.UnSubscribeToPacketType(packetsub2);
        ...
        private void BUT_OBmagcalcancel_Click(object sender, EventArgs e)
        {
            try
            {
                MainUI.comPort.doCommand(MAVLink.MAV_CMD.DO_CANCEL_MAG_CAL, 0, 0, 1, 0, 0, 0, 0);
            }
            catch (Exception ex)
            {
                CustomMessageBox.Show(ex.ToString(), Strings.ERROR, MessageBoxButtons.OK);
        ...
        private void buttonQuickPixhawk_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MainUI.comPort.setParam("COMPASS_USE", 1);
                MainUI.comPort.setParam("COMPASS_USE2", 1);
                MainUI.comPort.setParam("COMPASS_USE3", 0);
                MainUI.comPort.setParam("COMPASS_EXTERNAL", 1);
                MainUI.comPort.setParam("COMPASS_EXTERN2", 0);
                MainUI.comPort.setParam("COMPASS_EXTERN3", 0);

                MainUI.comPort.setParam("COMPASS_PRIMARY", 0);
                MainUI.comPort.setParam("COMPASS_LEARN", 1);
                ...
                else
                {
                    ...
                    MainUI.comPort.setParam("COMPASS_EXTERNAL", 0);
                }
            }
            catch (Exception)
            {
        ...
        private void QuickAPM25_Click(object sender, EventArgs e)
        {
            ...
            {
                CMB_compass1_orient.SelectedIndex = (int) Rotation.ROTATION_NONE;
                MainUI.comPort.setParam("COMPASS_USE1", 1);
                MainUI.comPort.setParam("COMPASS_USE2", 0);
                MainUI.comPort.setParam("COMPASS_USE3", 0);
                MainUI.comPort.setParam("COMPASS_EXTERNAL", 0);
                MainUI.comPort.setParam("COMPASS_EXTERN2", 0);
                MainUI.comPort.setParam("COMPASS_EXTERN3", 0);
        ...
        private void CHK_compasslearn_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (MainUI.comPort.MAV.param["COMPASS_LEARN"] == null)
                {
                    CustomMessageBox.Show("Not Available on " + MainUI.comPort.MAV.cs.firmware);
                }
                else
                {
                    MainUI.comPort.setParam("COMPASS_LEARN", ((CheckBox) sender).Checked ? 1 : 0);
                }
            }
            catch
            {
        ...
        private void ShowRelevantFields()
        {
            ...
            CMB_primary_compass.Visible = MainUI.comPort.MAV.param.ContainsKey("COMPASS_PRIMARY");
            LBL_primary_compass.Visible = MainUI.comPort.MAV.param.ContainsKey("COMPASS_PRIMARY");
        }
    }
}