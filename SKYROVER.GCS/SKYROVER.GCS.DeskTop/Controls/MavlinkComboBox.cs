        ...
        void MavlinkComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (_source != null)
            {
                try
                {
                    ...
                    if (!MainUI.comPort.setParam(ParamName, (float) (Int32) Enum.Parse(_source, this.Text)))
                    {
                    ...
                    {
                        if (
                            !MainUI.comPort.setParam(paramname2,
            ...
            else if (_source2 != null)
            {
                try
                {
                    ...
                    if (!MainUI.comPort.setParam(ParamName, (float) (int) ((MavlinkComboBox) sender).SelectedValue))
                    {
