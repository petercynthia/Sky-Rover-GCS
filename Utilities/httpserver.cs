    ...
    <Folder>
     ...
     string header =
                             ...
                             url.ToLower().Contains(" /both.jpg"))
                    {
                        ...
                        while (client.Connected)
                        {
                            System.Threading.Thread.Sleep(100); // 5hz
                            byte[] data = null;
                            ...
                            } else if (url.ToLower().Contains("all")) {

                                data = GetControlJpegRaw(GCSViews.FlightData.instance.tabControlactions);
                            }
                            else
                            {
                                GCSViews.FlightData.myhud.streamjpgenable = true;
                                ...
                                Image img3 = GetControlJpeg(GCSViews.FlightData.instance.tabControlactions);
                                ...
                                grap.DrawImageUnscaled(img3, 0, img1.Height);
